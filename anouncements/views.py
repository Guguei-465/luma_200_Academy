...
<<<<<<< HEAD
        ...
        # retrieve/update/destroy) 404s on an announcement they
        # didn't personally create just because its target audience
        # (e.g. "Teachers") wasn't in the filter. Previously this
